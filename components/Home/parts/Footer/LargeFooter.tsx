...
export function LargeFooter() {
  ...
  return (
    <div className="w-full pb-3 pt-8 md:mt-0 md:pb-3 md:pt-20">
      <div className="container mx-auto flex w-full flex-wrap items-start justify-between gap-5 md:gap-16">
        <Image
          src="/logo/logo.png"
          alt="Frame 2"
          width={20000}
      ...
      <div className="mx-auto mb-3 mt-8 w-full rounded-full border-b"></div>
      <div className="container mx-auto flex w-full flex-wrap justify-between gap-3 text-sm font-medium md:text-base">
